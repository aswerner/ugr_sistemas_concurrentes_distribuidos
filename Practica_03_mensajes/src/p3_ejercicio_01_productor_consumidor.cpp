 ...
 * ---------------------------------------------
 *
 *  El problema del productor-consumidor con paso de mensajes Open-MPI
 *
 *  NOTA: Tenemos 5 productores y 4 consumidores, hay que tenerlo en cuenta ya
 *  que se deben consumir todos los elementos producidos
 *
 ******************************************************************************/
